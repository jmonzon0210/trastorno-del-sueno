  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://sleepdisorder-detector.duckdns.org/api/api//predecir/",
    ...
    try {
      const response = await axios.post('https://sleepdisorder-detector.duckdns.org/api/api//save_patient/', dataToSend,
    {withCredentials: true}
  );
